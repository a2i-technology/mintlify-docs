...
**How they work together:** domains answer _what kind of work or written control is this?_ Functions answer _who owns this outcome?_ Programmes and initiatives **combine** several domains and several functions. The same word may label both a function and a domain (for example Engineering); each label answers its own question.
