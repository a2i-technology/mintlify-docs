...
- **Operations** — Programme and portfolio layout: **[Operations](/operations/)** and **[Portfolio](/operations/portfolio/)**. Follow existing programme front matter where used (e.g. `owner`, `status`).
