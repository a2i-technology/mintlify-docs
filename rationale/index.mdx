...
| **[Decision log](../governance/decision-log)** | Dated organisational resolutions (`DEC-*`). Each entry may include its own *Rationale* section for that decision. |
