...
- [Org Chart](/overview/systems/org/org-chart)
...
- **Contributor-facing detail:** [Org snapshot data](/overview/systems/org/org-data) and [Formatting standards — Org snapshot JSON](/overview/contributing/standards#org-snapshot-json).
